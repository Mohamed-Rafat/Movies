...
class UILabelX: UILabel {
    ...
    // Make Slash Text
    @IBInspectable var addSlash: Bool = false {
        didSet {
            if addSlash {
                let textWithSlash = makeSlashText(self.text ?? "")
                self.attributedText = textWithSlash
            }
        }
    }
    func makeSlashText(_ text:String) -> NSAttributedString {
